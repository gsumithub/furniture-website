      ...
      <div className='w-full min-h-[610px]'>
        ...
        <div className='max-w-[1220px] mx-auto py-5  '>
          <div className='w-full py-3 px-4 bg-slate-100 rounded-t-md border-1 border-slate-400 flex justify-between items-center'>
            <h2 className='text-2xl font-semibold'>View Color</h2>
          ...
          <table className='w-full'>
              <thead className='w-full bg-[#374151] text-left uppercase'>
                  <tr className=' text-sm font-normal text-gray-400'>
                    ...
                    <th className='w-[150px]  ps-2'>	Code</th>
                    
                    <th className='w-[120px] text-center ps-2'>	Order</th>
                    <th className='w-[150px] text-center  ps-2'>Status</th>
                    ...
                    data.map((obj,index)=>{
                      return(
                        <tr className='bg-gray-800 hover:bg-gray-600 text-left text-gray-400 '>
                          ...
                          <th  className='  ps-2'>{obj.code}</th>
                          
                          <th  className='text-center  ps-2'>{obj.order}</th>
                          {
                            obj.status ?
                          ...
                          <th  className='  ps-2 flex justify-center text-white font-semibold' >
                            <Link 
                              to={`/color/add/${obj._id}`}
                              className=''
                              >
