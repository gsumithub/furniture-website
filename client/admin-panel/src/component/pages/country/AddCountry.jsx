...
export default function AddCountry() {
  ...
  let handleSubmit=(e)=>{
    ...
    let url = id ? `country/update/${id}` : 'country/add'
    ...
    .then((finalRes)=>{
      ...
      if(finalRes._status){
        ...
        // });
        toast.success(id ? 'country updated successfully!' : 'country added successfully!')
        setTimeout(()=>{
  ...
  let updateData=()=>{
    ...
    // })   
      axios.get(`${apiBaseUrl}country/single-data/${id}`)
      .then((res) => {
        // console.log(res.data._data)
    ...
    <div>
      ...
      <div className='w-full min-h-[610px]'>
        <p className='px-6 py-3 border-b-2 border-[#ccc] w-full font-semibold text-gray-700'>
          ...
          <Link to=" " className='hover:text-blue-500'> Country</Link> /
        ...
        <div className='max-w-[1220px] mx-auto py-5  '>
          ...
          <div className='w-full py-3 px-4 rounded-b-md border-1 border-slate-400 border-t-0'>
            <form action="" onSubmit={handleSubmit}>
              <div className='mb-5'>
                <label htmlFor="" className='font-semibold mb-3'>Country Name</label>
                <input 
                  type="text" 
                  name='name'
