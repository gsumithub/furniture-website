      ...
      <div className='max-w-[1320px] mx-auto sm:py-10'>
        <div className='flex justify-center mb-5 px-4'>
          <img 
            ...
            alt="Welcome to Monista" 
            className="w-full max-w-[1200px] h-auto object-cover rounded-lg shadow-sm"
          />
        </div>
        <div className='text-center'>
          <h3 className='font-semibold font-serif text-2xl mb-5'>Welcome to Monista!</h3>
